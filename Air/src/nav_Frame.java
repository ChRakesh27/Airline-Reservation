...
public class nav_Frame extends javax.swing.JFrame {
    ...
    public nav_Frame(login log)
    {
        ...
        try
        {
        	img = ImageIO.read(new File("D:\\Rakesh\\eclipse\\project spec\\PROJECTAirlineResevationSystem_swings\\AirlineResevationSystem_swings\\AirlineResevationSystem_sourcecode\\src\\cloud.jpg"));
        }
        catch (Exception ex)
        {
            ex.printStackTrace();
